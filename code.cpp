...
public:
    double amount;
    string type;
    Transaction() : amount(0), type("N/A") {} 
    Transaction(double amount, string type) : amount(amount), type(type) {}
};
class BankAccount {
public:
...
int main() {
    ...
    int accountCount = 0;
    createAccount(accounts, accountCount, "12345", "Alice", 1000.0);
    createAccount(accounts, accountCount, "67890", "Bob", 500.0);
    ...
    while (true) {
        ...
        switch (choice) {
            ...
            case 6:               
                ...
                return 0;
            default:
                cout << "Invalid choice. Please try again." << endl<<endl; }    }    return 0;}
